...
class ModelExtensionDVuefrontProduct extends Model
{

    public function getProductRelated($product_id, $limit) {
    ...
    public function getProducts($data = array())
    {
        ...
        if(!empty($data['filter_product_ids'])) {
            $sql .= " AND p.product_id IN ('".implode("','", $data['filter_product_ids'])."') ";
        }

...
class ControllerDVuefrontCommonPage extends Controller
{
    private $codename = "d_vuefront";

    public function get($args)
    {
        $this->load->model($this->codename.'/page');
        $information_info = $this->model_d_vuefront_page->getPage($args['id']);
        $category_keyword = $this->model_d_vuefront_page->getPageKeyword($args['id']);
    ...
    public function getList($args)
    {
        ...
        $page_total = $this->model_d_vuefront_page->getTotalPages($filter_data);

        $results = $this->model_d_vuefront_page->getPages($filter_data);

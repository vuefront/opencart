...
class ControllerDVuefrontCommonZone extends Controller
{
    private $codename = 'd_vuefront';
    
    public function get($args)
    {
        $this->load->model($this->codename.'/zone');
        $zone_info = $this->model_d_vuefront_zone->getZone($args['id']);
    ...
    public function getList($args)
    {
        ...
        $zone_total = $this->model_d_vuefront_zone->getTotalZones($filter_data);

        $results = $this->model_d_vuefront_zone->getZones($filter_data);

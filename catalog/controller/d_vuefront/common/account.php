...
class ControllerDVuefrontCommonAccount extends Controller
{
    ...
    {
        $this->load->model('d_vuefront/address');

        $address_id = $this->model_d_vuefront_address->addAddress($this->customer->getId(), $args['address']);
    ...
    public function editAddress($args)
    {
        ...
        $this->model_d_vuefront_address->editAddress($args['id'], $args['address']);
    ...
    public function removeAddress($args)
    {
        ...
        $this->model_d_vuefront_address->deleteAddress($args['id']);

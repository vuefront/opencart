...
class ControllerDVuefrontStoreCategory extends Controller
{
    ...
    public function get($args)
    {
        ...
        $this->load->model($this->codename.'/category');
        $this->load->model('tool/image');
        $category_info = $this->model_catalog_category->getCategory($args['id']);
        $category_keyword = $this->model_d_vuefront_category->getCategoryKeyword($args['id']);
    ...
    public function getList($args)
    {
        ...
        $results = $this->model_d_vuefront_category->getCategories($filter_data);
        $category_total = $this->model_d_vuefront_category->getTotalCategories($filter_data);
    ...
    public function child($data)
    {
        ...
        $results = $this->model_d_vuefront_category->getCategories(array('parent' => $category_info['id']));

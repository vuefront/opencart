...
class ControllerDVuefrontStoreProduct extends Controller
{
    ...
    public function getList($args)
    {
        ...
        $this->load->model($this->codename . '/product');
        ...
        $product_total = $this->model_d_vuefront_product->getTotalProducts($filter_data);

        $results = $this->model_d_vuefront_product->getProducts($filter_data);
    ...
    public function get($args)
    {
        ...
        $product_keyword = $this->model_d_vuefront_product->getProductKeyword($args['id']);
        ...
        return array(
            ...
            'shortDescription' => utf8_substr(trim(strip_tags(html_entity_decode($product_info['description'], ENT_QUOTES, 'UTF-8'))), 0, $this->config->get('config_product_description_length')) . '..',
            'price' => $price,
            'special' => $special,

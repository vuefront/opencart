...
class ControllerExtensionDVuefrontCommonCountry extends Controller {

    private $codename = 'd_vuefront';
    
    public function get($args)
    {
        $this->load->model('extension/'.$this->codename.'/country');
        $information_info = $this->model_extension_d_vuefront_country->getCountry($args['id']);
    ...
    public function getList($args) {
        ...
        $country_total = $this->model_extension_d_vuefront_country->getTotalCountries($filter_data);

        $results = $this->model_extension_d_vuefront_country->getCountries($filter_data);
